...
function sitemap() {
    return __awaiter(this, void 0, Promise, function () {
        var baseUrl, posts, blogUrls;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    baseUrl = 'https://www.jusfishyandbeyond.com';
                    return [4 /*yield*/, sanity_1.client.fetch("*[_type == \"post\"]{ \"slug\": slug.current }")];
                case 1:
                    posts = _a.sent();
                    blogUrls = posts.map(function (post) { return ({
