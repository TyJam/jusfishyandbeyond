...
function BarGrid() {
    return (React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto" },
        React.createElement(framer_motion_1.motion.section, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, className: "bg-stone-900/40 backdrop-blur-2xl border border-white/10 rounded-[3.5rem] p-12 flex flex-col justify-between" },
            React.createElement("div", null,
                React.createElement("div", { className: "flex justify-between items-center mb-16" },
                    React.createElement("h2", { className: "text-4xl font-serif italic text-[#C5A059]" }, "Signature Cocktails"),
                    React.createElement(lucide_react_1.GlassWater, { className: "text-[#C5A059]", size: 24 })),
                React.createElement("div", { className: "space-y-10" }, cocktails.map(function (item) { return (React.createElement("div", { key: item.name, className: "group cursor-default" },
                    React.createElement("div", { className: "flex justify-between items-baseline" },
                        React.createElement("h4", { className: "font-bold tracking-[0.2em] uppercase text-xs group-hover:text-[#C5A059] transition-colors" }, item.name),
        ...
        React.createElement("div", { className: "flex flex-col gap-8" },
            React.createElement(framer_motion_1.motion.section, { initial: { opacity: 0, scale: 0.95 }, whileInView: { opacity: 1, scale: 1 }, className: "bg-[#1B4D3E] rounded-[3.5rem] p-12 flex-1" },
            ...
            React.createElement("div", { className: "bg-stone-900/60 rounded-[2.5rem] p-8 border border-white/5" },
                React.createElement("div", { className: "flex items-center gap-4" },
                    React.createElement(lucide_react_1.Star, { size: 14, className: "text-[#C5A059]" }),
                    React.createElement("p", { className: "text-[10px] font-bold tracking-[0.4em] uppercase text-white/60" }, "Sodas $3 \u2022 Water $1.75")))),
        React.createElement(framer_motion_1.motion.section, { initial: { opacity: 0 }, whileInView: { opacity: 1 }, className: "md:col-span-2 bg-[#C5A059] rounded-[3.5rem] p-12 text-jusBlack flex flex-col md:flex-row justify-between items-center shadow-xl" },
