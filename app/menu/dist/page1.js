...
function BentoMenu() {
    ...
    return (React.createElement("div", { className: "bg-[#fdfcf8] min-h-screen p-6 md:p-12 pb-40" },
        React.createElement("header", { className: "mb-12 max-w-7xl mx-auto" },
            React.createElement("h1", { className: "text-5xl font-serif text-[#1B4D3E]" }, "The Menu")),
        React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-4 auto-rows-[280px] gap-6 max-w-7xl mx-auto relative" }, menuData_1.menuSections.map(function (section) {
            ...
            return (React.createElement("div", { key: section.id, className: spanClass + " relative" },
                React.createElement("div", { className: "relative h-full w-full bg-white border border-stone-200 rounded-[2rem] overflow-hidden shadow-sm flex flex-col group" },
                    section.image && (React.createElement("div", { className: "absolute inset-0 z-0" },
                        React.createElement("img", { src: section.image, className: "w-full h-full object-cover grayscale opacity-30 group-hover:opacity-100 group-hover:grayscale-0 transition-all duration-700", alt: section.title }),
                    ...
                    React.createElement(framer_motion_1.AnimatePresence, null, isExpanded && (React.createElement(framer_motion_1.motion.div, { initial: { y: "100%" }, animate: { y: 0 }, exit: { y: "100%" }, transition: { type: "spring", damping: 25, stiffness: 200 }, className: "absolute inset-0 z-50 bg-[#1B4D3E] p-8 overflow-y-auto" },
                        React.createElement("div", { className: "flex justify-between items-center mb-8" },
                            React.createElement("h2", { className: "text-white font-black tracking-widest uppercase text-[11px] border-b-2 border-white/20 pb-2 w-fit" }, section.title),
